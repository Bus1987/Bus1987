  ...
  return (
    <section id="about" className="relative overflow-hidden bg-[linear-gradient(180deg,#1e447c_0%,#2c5ca5_55%,#3a72c0_100%)] py-16 text-white sm:py-20">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:items-center">
        <div>
          <p className="text-sm font-semibold tracking-wide text-cyan">เกี่ยวกับเรา</p>
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-white/85">
            ผู้ให้บริการด้านคอมพิวเตอร์และเทคโนโลยีดิจิทัล ที่ระยอง ประเทศไทย
            รับดูแลงานซ่อมคอมพิวเตอร์ โน้ตบุ๊ก ลงโปรแกรม ติดตั้ง อัปเกรด
            ทำความสะอาดเครื่อง ให้คำปรึกษา และ IT Support แบบครบวงจร
          </p>
          <div className="mt-8 rounded-3xl bg-white/10 p-5 ring-1 ring-white/15">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-sky">ผู้บริหาร</p>
      ...
      <div className="grid gap-6 px-6 py-6 sm:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="text-center">
          ...
          <div className="mt-3 grid grid-cols-3 gap-2">
            <img src="/qr-web.svg" alt="QR เว็บไซต์" className="rounded-md ring-1 ring-sky-mid" />
            <img src="/qr-email.svg" alt="QR อีเมล" className="rounded-md ring-1 ring-sky-mid" />
            <img src="/qr-line.svg" alt="QR LINE" className="rounded-md ring-1 ring-sky-mid" />
          </div>
        </div>
      </div>
