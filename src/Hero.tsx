      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:py-20">
        <div>
          ...
          <h1 className="mt-5 text-4xl font-extrabold leading-tight text-ink sm:text-5xl lg:text-[3.35rem]">
            ซ่อมคอมพิวเตอร์ โน้ตบุ๊ก
            <span className="block text-royal">และไอทีครบวงจร</span>
          </h1>
          <p className="mt-5 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
            ที่ปรึกษาปัญหาคอมพิวเตอร์ ลงโปรแกรม ติดตั้ง อัปเกรด ครบวงจร
            โดย {brand.name} ดูแลงานตั้งแต่ตรวจเช็คจนถึงส่งมอบ ที่{brand.locationTh}
          </p>
          ...
          <ul className="mt-8 flex flex-wrap gap-2 text-sm text-muted">
            {['ซ่อม PC / โน้ตบุ๊ก', 'Windows และซอฟต์แวร์', 'RAM / SSD', 'IT Support'].map((item) => (
